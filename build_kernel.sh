...
mkdir out
chmod -R 777 out
make -C $(pwd) O=out -j5 ARCH=arm64 CROSS_COMPILE=/home/mehanik6/lineage-16.0/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- KCFLAGS=-mno-android  gto_eur_open_defconfig

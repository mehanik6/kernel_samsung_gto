...
enum power_supply_notifier_events {
	...
	PSY_EVENT_PROP_ADDED,   /*Bug 427683 huangcunzhu_wt,20190123,add,sar sensor bringup*/
...
struct power_supply {
	...
	const char *name; //Bug 427683 huangcunzhu_wt,20190123,add,sar sensor bringup

#ifdef CONFIG_USB_NOTIFIER
	int usb_host_flag; 		//bug433318, zhaobeilong@wt, 20180409, add usb disable node
#endif

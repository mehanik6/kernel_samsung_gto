...
static bool floated_charger_enable = 1;//Bug 432430 caijiaqi.wt,MODIFIY,20190313,Non-standard charge is recognized as usb modification, setting non-standard charge current
...
static bool chg_detection_for_float_charger = 1;//Bug 432430 caijiaqi.wt,MODIFIY,20190313,Non-standard charge is recognized as usb modification, setting non-standard charge current

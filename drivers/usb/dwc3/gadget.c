...
static int dwc3_gadget_run_stop(struct dwc3 *dwc, int is_on, int suspend)
{
	...
	if (is_on) {
		...
		/*ExtB190806-01740,zhaobeilong@wt,2019-8-21,MODEM CRASH UPLOAD MODE occur while charging,start*/
		/*
		 * Reset the err_evt_seen so that the interrupts on
		 * next connect/session is processed correctly.
		 */
		dwc->err_evt_seen = false;
		/*ExtB190806-01740,zhaobeilong@wt,2019-8-21,MODEM CRASH UPLOAD MODE occur while charging,end*/
		...
		const struct dwc3_event_devt *event)
{
	...
	case DWC3_DEVICE_EVENT_ERRATIC_ERROR:
		...
		dbg_event(0xFF, "ERROR", dwc->retries_on_error);   /*ExtB190806-01740,zhaobeilong@wt,2019-8-21,MODEM CRASH UPLOAD MODE occur while charging*/
	...
	while (left > 0) {
		...
		if (dwc->err_evt_seen) {
			...
			if (dwc3_notify_event(dwc,
					...
					dwc->err_evt_seen = 0;
			dwc->retries_on_error++;    /*ExtB190806-01740,zhaobeilong@wt,2019-8-21,MODEM CRASH UPLOAD MODE occur while charging*/
			break;
		}

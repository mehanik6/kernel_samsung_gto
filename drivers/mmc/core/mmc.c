		...
		char *buf)
{
	...
	return sprintf(buf, "W%02X%02X%02X%X%02X%08X%02X\n",
...
MMC_DEV_ATTR(life_time, "0x%02x 0x%02x\n",
	card->ext_csd.device_life_time_est_typ_a,
	card->ext_csd.device_life_time_est_typ_b);
MMC_DEV_ATTR(life_time_est_typ_a, "0x%02x\n",card->ext_csd.device_life_time_est_typ_a);//bug428272,zhaobeilong.wt,20190125,add life_time_a node
MMC_DEV_ATTR(life_time_est_typ_b, "0x%02x\n",card->ext_csd.device_life_time_est_typ_b);//bug428272,zhaobeilong.wt,20190125,add life_time_b node
...
//bug428245, zhaobeilong@wt,add,20180125,add flash_name node,start
...
//bug428245, zhaobeilong@wt,add,20180125,add flash_name node,end
...
static struct attribute *mmc_std_attrs[] = {
	...
	&dev_attr_life_time_est_typ_a.attr,      //bug428272,zhaobeilong.wt,20190125,add life_time_a node
	&dev_attr_life_time_est_typ_b.attr,      //bug428272,zhaobeilong.wt,20190125,add life_time_b node
	...
	&dev_attr_flash_name.attr, //bug428245 , zhaobeilong@wt,add,20180125,add flash_name node
	NULL,
};

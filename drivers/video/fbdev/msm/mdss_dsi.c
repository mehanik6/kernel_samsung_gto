...
/* bug 458842, wangminglin.wt, 2019/0719, Modify nt36525 txd timming sequence, start */
	if (pdata->panel_info.panel_name_id == NT36525B_TXD_HDP_VIDEO_PANEL) {
		ret = mdss_dsi_panel_reset(pdata, 1);  // before lp11 do lcd reset high low higt

		ret = mdss_dsi_panel_reset(pdata, 0);  // free lcd reset
		pr_err("%s: Panel reset nt36525. rc=%d\n",
						__func__, ret);
	}
/* bug 458842, wangminglin.wt, 2019/0719, Modify nt36525 txd timming sequence, end */

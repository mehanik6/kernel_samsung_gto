...
/* bug 428240 , wangminglin.wt, 2019/0125, Add Lcd lcd name in boardinfo, start*/
#include <linux/hardware_info.h>
extern char Lcm_name[HARDWARE_MAX_ITEM_LONGTH];
/* bug 428240 , wangminglin.wt, 2019/0125, Add Lcd lcd name in boardinfo, end*/
...
/* bug 450537, wangminglin.wt, 2019/0612, Modify panel timming, end */
...
/* bug 450537, wangminglin.wt, 2019/0612, Modify panel timming, start*/
	if (strncmp(ctrl->panel_data.panel_info.panel_name, "ili9881h", strlen("ili9881h")) == 0) {
	...
	} else if (strncmp(ctrl->panel_data.panel_info.panel_name, "nt36525b", strlen("nt36525b")) == 0) {
		...
		led_pwm2[1] = (unsigned char)(level >> 8);
		if ((level > 0) &&(level < 16))
			led_pwm2[2] = 16; // let the minimum brightness reach 3nit
		else
			led_pwm2[2] = (unsigned char)level;
...
/* bug 464691, wangminglin.wt, 2019/0807, Modify disable dimming when first on backlight, start*/
    pinfo->first_on_backlight = 1;
/* bug 464691, wangminglin.wt, 2019/0807, Modify disable dimming when first on backlight, end*/

...
/*bug428380, add, zouhaifeng.wt, 20190126, printk output more information for better debugging*/
...
//mayuwu.wt 20181207,add log avoid init log loss
...
static void sec_log_add(const struct printk_log *msg)
{
	...
	static enum log_flags prev_flag;
	size_t size = 0;
	int i;
